...
$select_option = $areaObj->area_option ( $optiontpl, $aid );

/* 提交url */
$submiturl = url ( 'index', 'mod/member/ac/admin/op/area/ao/area_addsetdo' );
