...
<div class="clearfix ul-box">
    ...
    <ul class="ubox">
        <li class="clearfix is">
			...
			<span class="tc-a fw"><?php prt($CUserRs['cname']); ?></span>
		</li>
	</ul>
</div>
...
<div class="clearfix" tab="yes">
    ...
    <div class="clearfix table-box">
        <table class="tbox">
            ...
            <td colspan="5">
            	<span class="z"><button type="button" name="disabled-buttons" class="fbtn-ds" onclick="fsdo_zplx(this);" id="btn_zplx">提交</button></span>
...
$("#body").cjslip({
	...
	completeFunc: function(i){
		__act_falgIndex = i;
		__curHref = (window.location.href + "&tab=" + i);
	}
});
...
var __actUrl = "<?php prt(_g('cp')->uri('mod/user/ac/cuser/op/detail_update')); ?>";
/* base */
