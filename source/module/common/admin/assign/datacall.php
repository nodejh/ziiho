...
/* 数据调用 */
$c = loader ( 'class:class_common_datacall', $module, true, true );

$db = $c->db;
/* 查询 */
$db->from ( $c->table_common_datacall );
/* 获取总数 */
