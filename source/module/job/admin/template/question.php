...
<div class="clearfix table-box">
    ...
    <table class="tbox">
        ...
        <tr class="trow-bline bg-hover-a">
            ...
            <td width="44%"><a href="<?php prt(_g('cp')->uri('mod/job/ac/question/op/sortset/questionid/' . $rs['questionid'] . '/url/' . $backUrlStr)); ?>" class="tc-a">分类设置</a>&nbsp;&nbsp;<a href="<?php prt(_g('cp')->uri($subjectUrl . '/sortid/' . $sortid . '/questionid/' . $rs['questionid'])); ?>" class="tc-a">题目管理</a></td>
        </tr>
        <?php } ?>
        <?php } ?>
