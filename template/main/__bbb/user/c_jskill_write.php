...
<div class="cuser_y clearfix">
	<div class="label">
    	<a href="<?php prt(_g('uri')->su('user/t/c_jskill')); ?>">&laquo;返回</a>
    </div>
    <div class="form-item clearfix">
    	...
    	<ul class="form-box">
            ...
            <li class="clearfix">
            	<div class="lab">&nbsp;</div>
                <div class="btns"><button type="button" class="btn" name="disabled-buttons" onclick="cUserSKillWrite(this, '<?php prt(_g('uri')->su('user/t/c_jskill/op/write_save')); ?>', '<?php prt(_g('uri')->su('user/t/c_jskill')); ?>');">提交并保存</button></div>
            </li>
        </ul>
        </form>
    </div>
...
_jtypeDataAppend("<?php prt(my_array_value('jtypeid', $skillsub)); ?>");
</script>
