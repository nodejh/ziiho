...
<div class="cuser_y clearfix">
	<div class="label">
    	<a href="<?php prt(_g('uri')->su('user/t/c_job/op/write')); ?>">+添加项目</a>
    </div>
    <div class="datas">
    	...
    	<table class="tbox">
            ...
            <tr class="trow-bline trow-hover" >
                ...
                <td width="30%"><?php prt($JTYPE->getValue($jRs['jtypeid'], 'jtname')); ?></td>
                <td width="20%"><?php prt($jRs['pnum']); ?>人</td>
                <td width="50%" class="ops"><a href="<?php prt(_g('uri')->su('user/t/c_job/op/write/jobid/' . $jRs['jobid'])); ?>">修改</a><a href="javascript:;" onclick="cUserJobDelete(this, '<?php prt(_g('uri')->su('user/t/c_job/op/delete')); ?>');" data-id="<?php prt($jRs['jobid']); ?>">删除</a></td>
            </tr>
            <?php endwhile; ?>
        </table>
    </div>
