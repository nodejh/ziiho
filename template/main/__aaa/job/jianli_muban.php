...
<div class="muban-area clearfix">
    ...
    <div class="sels clearfix">
        <a href="<?php prt(_g('uri')->su('job/ac/jianligonglue/op/muban/order/1')); ?>" class="on" id="order-time"><i class="fa fa-clock-o"></i>最新</a>
        <a href="<?php prt(_g('uri')->su('job/ac/jianligonglue/op/muban/order/2')); ?>" class="def" id="order-count"><i class="fa fa-fire"></i>人气</a>
        <a href="<?php prt(_g('uri')->su('job/ac/jianligonglue/op/muban/order/3')); ?>" class="def" id="order-link"><i class="fa fa-link"></i>相关</a>
    </div>
    <!-- sels// -->
                ...
                foreach ($muban as $k => $v) {
                    ...
                    <li class="clearfix">
                        ...
                        <div class="bbb clearfix">
                            <div class="ttt"><a href="<?php prt(_g('uri')->su('job/ac/jianligonglue/op/muban_detail/mbid/' . $v['0'])); ?>"><?php echo $v['1']; ?></a></div>
                            <div class="des">
                                <p>模板特点：</p>
                                <p> <?php echo $v['4']; ?></p>
                            </div>
