    ...
    <div class="datas">
    	...
    	<table class="tbox">
            ...
            <tr class="trow-bline trow-hover" >
                ...
                <td width="50%" class="ops"><a href="<?php prt(_g('uri')->su('user/t/c_job/op/esanswer_read/jobid/' . $jobid . '/uid/' . $esaRs['uid'])); ?>">查看答卷</a><a href="javascript:;" onclick="cUserSKillDelete(this, '<?php prt(_g('uri')->su('user/t/c_job/op/skill_delete')); ?>');" data-id="<?php prt($esaRs['esid']); ?>">删除</a></td>
            </tr>
            <?php }; ?>
            <?php }else{ ?>
            <tr class="trow-bline trow-hover" >
