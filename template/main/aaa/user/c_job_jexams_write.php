...
<div class="cuser_y clearfix">
    ...
    <div class="form-item clearfix">
    	...
    	<ul class="form-box">
            ...
            <li class="clearfix">
            	<div class="lab">&nbsp;</div>
                <div class="btns"><button type="button" class="btn" name="disabled-buttons" onclick="cUserExamSubjectWrite(this, '<?php prt(_g('uri')->su('user/t/c_job/op/jexams_write_save')); ?>', '<?php prt(_g('uri')->referer()); ?>');">提交</button></div>
            </li>
        </ul>
        </form>
    </div>
