...
<div class="clearfix resume_r_data_write">
    ...
    <ul>
        ...
        <li class="bline clearfix">
            ...
            <div class="ii">
                <input type="text" class="ii-inp" name="pname" value="<?php prt(my_array_value('pname', $projectexpRs)); ?>" />
                
                开发工具：
                <input type="text" class="ii-inp" name="tool" value="<?php prt(my_array_value('tool', $projectexpRs)); ?>" />
            </div>
        </li>
        ...
        <li class="bline clearfix">
            ...
            <div class="ii">
                <input type="text" class="ii-inp" name="hardware" value="<?php prt(my_array_value('hardware', $projectexpRs)); ?>" />
                
                软件环境：
                <input type="text" class="ii-inp" name="software" value="<?php prt(my_array_value('software', $projectexpRs)); ?>" />
            </div>
        </li>
        
        <li class="clearfix">
            <div class="nn">项目描述:</div>
            <div class="ii"><textarea projectexp="pdesc" name="pdesc" style="width:540px; height:80px;"><?php prt(my_array_value('pdesc', $projectexpRs)); ?></textarea></div>
        </li>
        
        
        <li class="clearfix">
            <div class="nn">责任描述:</div>
            <div class="ii"><textarea projectexp="responsible" name="responsible" style="width:540px; height:80px;"><?php prt(my_array_value('responsible', $projectexpRs)); ?></textarea></div>
        </li>
        <li class="clearfix">
            <div class="nn">&nbsp;</div>
