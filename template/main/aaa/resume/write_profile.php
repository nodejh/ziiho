...
<div class="bd-box bd-box-none clearfix" id="base_box">
    ...
    <ul>
        <li class="bline clearfix">
            <div class="nn">姓名:</div>
            <div class="ii">
            <input type="text" class="ii-inp" name="chname" value="<?php prt(my_array_value('chname', $resumeProfile)); ?>" />
            性别:
        ...
        <li class="bline clearfix">
            ...
            <div class="ii">
                <input type="text" name="birthday" class="ii-calendar" value="<?php prt(date("Y-m-d", my_array_value('birthday',$resumeProfile)));?>" readonly="readonly" onclick="WdatePicker({isShowClear:false,readOnly:true,'dateFmt':'yyyy-MM-dd',isShowToday:false,qsEnabled:false,isShowOK:false,minDate:'1960-01-01',maxDate:'<?php prt(date("Y-m-d", _g('cfg>time'))); ?>'})"/>
            </div>
        </li>
        ...
        <li class="bline clearfix">
            ...
            <div class="ii">
                <select class="sel" name="phonearea">
                ...
                <input type="text" class="ii-inp" name="mobilephone" value="<?php prt(my_array_value('mobilephone', $resumeProfile)); ?>" />
            </div>
        </li>
        
        <li class="bline clearfix">
            <div class="nn">邮箱:</div>
            <div class="ii"><input type="text" class="ii-inp" name="email" value="<?php prt(my_array_value('email', $resumeProfile)); ?>" /></div>
        </li>
        ...
        <li class="bline clearfix">
            ...
            <div class="ii"><div class="clearfix" id="area-data-1"></div><input type="hidden" name="home" /></div>
        </li>
    </ul>
    ...
    <div class="clearfix base-more">
        <ul>
            ...
            <li class="bline clearfix">
                ...
                <input type="text" class="ii-inp" name="idstr" value="<?php prt(my_array_value('idstr', $resumeProfile)); ?>" />
                </div>
            </li>
            ...
            <li class="bline clearfix">
                ...
                <div class="ii">
                <select class="sel" name="maritalstatus">
                    <option value="-1">-</option>
                ...
                身高:
               <input type="text" class="ii-inp2" name="height" value="<?php prt(my_array_value('height', $resumeProfile)); ?>" />&nbsp;cm
                </div>
            </li>
            ...
            <li class="bline clearfix">
                ...
                <div class="ii">
                <select class="sel" name="politicalstatus">
                    <option value="-1">-</option>
            ...
            <li class="bline clearfix">
                ...
                <div class="ii">
                    <input type="text" class="ii-inp" name="qq" value="<?php prt(my_array_value('qq', $resumeProfile)); ?>" />
                </div>
            </li>
        </ul>
    </div>
