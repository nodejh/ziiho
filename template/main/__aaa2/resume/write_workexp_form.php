...
<div class="clearfix resume_r_data_write">
    ...
    <ul>
        ...
        <li class="bline clearfix">
            ...
            <div class="ii">
                <input type="text" class="ii-inp" name="company" value="<?php prt(my_array_value('company', $workexpRs)); ?>" />
            </div>
        </li>
        ...
        <li class="bline clearfix">
            ...
            <div class="ii">
                <select class="sel" name="sortid" workexp="sortid" def="<?php prt(my_array_value('sortid', $workexpRs)); ?>">
                <option value="-1">-</option>
            	</select>
            </div>
        </li>
        ...
        <li class="bline clearfix">
            <div class="nn">部门:</div>
            <div class="ii">
                <input type="text" class="ii-inp" name="department" value="<?php prt(my_array_value('department', $workexpRs)); ?>" />
            </div>
        </li>
        ...
        <li class="bline clearfix">
            <div class="nn">职位:</div>
            <div class="ii">
                <select class="sel" name="sortid2" workexp="sortid2" def="<?php prt(my_array_value('sortid2', $workexpRs)); ?>">
                <option value="-1">-</option>
            	</select>

                <input type="text" class="ii-inp" name="sortid2_input" value="<?php prt(my_array_value('sortid2_input', $workexpRs)); ?>" />
            </div>
        </li>
        
        <li class="clearfix">
            <div class="nn">工作描述:</div>
            <div class="ii"><textarea workexp="description" name="description" style="width:540px; height:80px;"><?php prt(my_array_value('description', $workexpRs)); ?></textarea></div>
        </li>
