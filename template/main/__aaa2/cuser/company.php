        ...
        <div class="company-tab-bd clearfix">
            ...
            <div class="bd-box bd-box-none clearfix">
                ...
                <ul>
                    ...
                    <li class="bline clearfix">
                        ...
                        <div class="ii">
                        	<select class="sel" name="cnatureid">
                            	<option value="0">==请选择==</option>
                                <?php foreach(_g('cache')->selectitem(119) as $k=>$v){ ?>
                                <option value="<?php prt($k); ?>" <?php if(my_array_value('cnatureid', $cUserData)==$k){ ?>selected="selected"<?php } ?>><?php prt($v['sname']); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </li>
                    ...
                    <li class="bline clearfix">
                        ...
                        <div class="ii">
                        	<select class="sel" name="csize">
                                ...
                                <option value="<?php prt($k); ?>" <?php if(my_array_value('csize', $cUserData)==$k){ ?>selected="selected"<?php } ?>><?php prt($v['sname']); ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </li>
            ...
            <div class="bd-box bd-box-none clearfix">
                ...
                <ul>
                    ...
                    <li class="bline clearfix">
                        <div class="ii"><a href="javascript:;" flag="del" onclick="cuserInfo_logo(this);">重新上传</a></div>
                        <div class="clear"></div>
                        <div class="file-area mt8 clearfix"><img src="<?php prt(sdir('uploadfile') . '/' . $cUserData['logo']); ?>" width="100" /></div>
                    </li>
                    <?php }else{ ?>
                    <li class="bline clearfix">
            ...
            <div class="bd-box bd-box-none clearfix">
                ...
                <ul>
                    ...
                    <li class="bline clearfix">
                        <div class="ii"><a href="javascript:;" flag="del" onclick="cuserInfo_licence(this);">重新上传</a></div>
                        <div class="clear"></div>
                        <div class="file-area mt8 clearfix"><img src="<?php prt(sdir('uploadfile') . '/' . $cUserData['licence']); ?>" width="100" /></div>
                    </li>
                    <?php }else{ ?>
                    <li class="bline clearfix">
                        <div class="file-area clearfix">
