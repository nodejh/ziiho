...
<!-- //job-company-rz -->
<div class="com-w job-company-rz clearfix" id="job-company-rz">
   <!-- //tt -->
    ...
    <div class="nns clearfix">
    	<span class="bbs"><em checkbox-flag="ck"><input type="checkbox" name="cb_agree" value="1" />我已阅读此条款</em><button type="button" class="ok ok-off">下一步</button></span>
        <a href="<?php prt(_g('uri')->su('job/ac/company/op/jobstep/id/' . _get('id') . '/jobid/' . $jobid)); ?>">返回</a>
    </div>
</div>
<!-- job-company-rz// -->
<script language="javascript">
var _okObj = $("#job-company-rz").find(".ok");
var _isCheckedFlag = false;
_GESHAI.checkbox({ checkboxItem: "em[checkbox-flag=ck]", name: "cb_agree", fFunc: function(){ _isCheckedFlag = false; _okObj.addClass("ok-off"); }, tFunc: function(){ _isCheckedFlag = true; _okObj.removeClass("ok-off"); } });
_okObj.click(function(e) {
	if(!_isCheckedFlag){ _GESHAI.dialog({isCloseBtn: false, clickBgClose: true, data: "对不起，请先阅读并同意此条款！"}); return null; }
