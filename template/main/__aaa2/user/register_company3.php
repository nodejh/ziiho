...
<!-- //register-iarea -->
<div class="register-iarea register-iarea-mt clearfix" id="register_index">
	<!-- //steps -->
    ...
    <div class="z succ clearfix">
        ...
        <div class="ss clearfix">
        	<p class="sc">您的网站账号：<em class="lf"><?php prt($CUser->sess_cuser('username')); ?></em></p>
            <p class="sc">请记住您的卡号，便于您电话预订时使用。</p>
            <p class="sc">您的公司邮箱为：<em class="lf"><?php prt($CUser->sess_cuser('cemail')); ?></em></p>
