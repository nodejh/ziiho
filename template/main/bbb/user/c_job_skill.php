...
<div class="cuser_y clearfix">
	<div class="label clearfix">
    	...
    	<a class="add" href="<?php prt(_g('uri')->su('user/t/c_job/op/skill_write/jobid/' . $jobid)); ?>">+添加学习方案</a>
    </div>
    <div class="datas">
    	...
    	<table class="tbox">
            ...
            <tr class="trow-bline trow-hover" >
                ...
                <td width="20%" class="ops"><a href="<?php prt(_g('uri')->su('user/t/c_job/op/skill_write/jobid/' . $jobid . '/skillid/' . $skRs['skillid'])); ?>">修改</a><a href="javascript:;" onclick="cUserSKillDelete(this, '<?php prt(_g('uri')->su('user/t/c_job/op/skill_delete')); ?>');" data-id="<?php prt($skRs['skillid']); ?>">删除</a></td>
            </tr>
            <?php endwhile; ?>
        </table>
    </div>
