...
<div class="cuser_y clearfix">
    ...
    <div class="form-item clearfix">
    	...
    	<ul class="form-box">
            ...
            <li class="clearfix">
            	<div class="lab">&nbsp;</div>
                <div class="btns"><button type="button" class="btn" name="disabled-buttons" onclick="cUserSKillWrite(this, '<?php prt(_g('uri')->su('user/ac/job/op/skill_write_save')); ?>', '<?php prt(_g('uri')->referer()); ?>');">提交并保存</button></div>
            </li>
        </ul>
        </form>
    </div>
