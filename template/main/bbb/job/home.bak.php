...
<div class="banner clearfix" id="banner">
	...
	<div class="cbox clearfix">
		...
		<div class="x bi clearfix">
			<a href="<?php prt(_g('uri')->su('job/ac/learn/op/assess')); ?>" id="home-learn" class="color-white">
                <div class="aa clearfix" style="margin-left: 40%;">认证中心</div></a>
			    <div class="bb clearfix" style="margin-left: 40%;">LEARN CENTER</div>
			    <div class="cc clearfix" style="margin-left: 40%;">针对于职位的认证</div>
		</div>

		<div class="y bi clearfix">
            <a href="<?php prt(_g('uri')->su('job/ac/job')); ?>" id="home-job" class="color-white"><div class="aa clearfix">推荐求职</div></a>
