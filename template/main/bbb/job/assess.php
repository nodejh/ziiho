        ...
        <div class="col-xs-12 col-sm-10 col-sm-offset-1">
            ...
            <div class="zh-list container-fluid">
                <div class="row zh-row zh-assess-border-top">
                    ...
                    <div class="col-xs-11">
                        <!-- <div class="col-xs-2"> -->
                        <a <?php prt($spid == 'a' ? 'class="zh-active zh-list-tips-right"' : 'class="zh-font-grey zh-list-tips-right"'); ?> href="<?php prt(_g('uri')->su('job/ac/learn/op/assess/')); ?>">全部</a>
                        <!-- </div>	 -->
                        <!-- <div class="row"> -->
                        <?php foreach($parentResult as $value){ ?>
                            <!-- <div class="col-xs-2 zh-list-tips-div"> -->
                            <a <?php prt($spid == $value['sortid'] ? 'class="zh-active zh-list-tips"' : 'class="zh-font-grey zh-list-tips"'); ?> href="<?php prt(_g('uri')->su('job/ac/learn/op/assess/spid/' . $value['sortid'])); ?>"><?php prt($value['sname']); ?></a>
                            <!-- </div> -->
                        <?php } ?>
                        <!-- </div>	 -->
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-11">
                        <a <?php prt($scid == 'a' ? 'class="zh-active zh-list-tips-right"' : 'class="zh-font-grey zh-list-tips-right"'); ?> href="<?php prt(_g('uri')->su('job/ac/learn/op/assess/spid/' . $spid . '/scid/a')); ?>">全部</a>
                        <?php foreach($childResult as $child){ ?>
                            <a <?php prt($scid == $child['sortid'] ? 'class="class="zh-active zh-list-tips"' : 'class="zh-font-grey zh-list-tips"'); ?> href="<?php prt(_g('uri')->su('job/ac/learn/op/assess/spid/' . $spid . '/scid/' . $child['sortid'])); ?>"><?php prt($child['sname']); ?></a>
                        <?php } ?>
                    </div>
                </div>
            </div>
