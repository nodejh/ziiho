        ...
        <div class="col-xs-12 col-sm-10 col-sm-offset-1">
            ...
            <div class="panel panel-info">
              <div class="panel-heading">
                <h3 class="panel-title">认证介绍    </h3>
              </div>
              <div class="panel-body zh-company-jobrz-panel-body">
            ...
            <div class="zh-company-jobrz-btn">
                <span id="check"><input type="checkbox" id="checkbox" checked="checked" /><label for="checkbox">我已阅读此条款</label></span> 
                <a class="btn btn-primary btn-lg" href="<?php prt(_g('uri')->su('job/ac/company/op/exam/id/' . _get('id') . '/jobid/' . $jobid)); ?>" role="button"> 下一步</a>
                <a class="btn btn-default" href="<?php prt(_g('uri')->su('job/ac/company/op/jobstep/id/' . _get('id') . '/jobid/' . $jobid)); ?>" role="button"> 返回</a>
            </div>
        </div>
    </div>
</div>
